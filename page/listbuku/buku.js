                ...
                $.each(result.rows, function(i, rows){
                    $('#data').find('tbody').append(`
                        <tr>
                          ...
                          <td>
                            <a href='ubah-data-peminjaman.php?id=${rows.kode_buku}'>
                              <button type='button' class='btn btn-primary'><i class='fas fa-wrench'></i></button>
                            </a>
                            <a href='kelola-pengembalian.php?id=${rows.kode_buku}' onclick='return confirm(\" Apakah Anda Benar Buku Akan di Kembalikan ? \");'>
